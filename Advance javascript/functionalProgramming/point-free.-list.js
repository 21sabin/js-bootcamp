let books = [
    ...
    function getBooks(){
        return books.filter(selectBooksOfColumbia)
         .map(toBookView)
        .sort(sortByName)
    }

    function selectBooksOfColumbia( book ){
        return book.country==='Colombia';
    }
    ...
    function sortByName(book1,book2){
